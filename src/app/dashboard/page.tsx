    ...
    <section className="relative overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-12 mb-20 text-center sm:text-left">
          <div>
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-display font-bold text-[#1c1c1c] tracking-tight leading-tight">
              Dashboard {userStats?.accountType !== 'B2C_FREE' ? 'Pro' : 'Saya'}
            </h1>
            <p className="text-sm lg:text-lg text-[#6b6b6b] mt-3 lg:mt-4 max-w-2xl">
          ...
          <Link href="/create" className="w-full sm:w-auto">
            <Button size="lg" className="w-full sm:w-auto h-12 lg:h-16 px-6 lg:px-10 bg-rose-gradient text-white shadow-xl shadow-rose-500/20 hover:shadow-rose-500/40 rounded-2xl font-bold text-sm lg:text-base">
