...
export default function ClientDashboardPage() {
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          ...
          <p className="text-sm text-[#8c8885]">Memuat dashboard...</p>
        </div>
      </div>
    );
  }
  ...
  if (!data?.invitation) {
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center bg-white rounded-3xl p-12 border border-[#f0ebe1] shadow-sm max-w-md">
          <div className="inline-flex p-5 rounded-2xl bg-rose-50 mb-6">
            <Heart className="h-10 w-10 text-rose-300" />
          </div>
          <h2 className="text-xl font-display font-bold text-[#2c2a29] mb-2">
            Belum Ada Undangan
          </h2>
          <p className="text-sm text-[#8c8885] leading-relaxed">
            Undangan Anda sedang disiapkan oleh vendor. Silakan cek kembali nanti.
          </p>
        </div>
      </div>
    );
  ...
  const { invitation, stats, guests } = data;
