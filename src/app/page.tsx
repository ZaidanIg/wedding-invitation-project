...
export default function HomePage() {
  return (
    <div className="bg-[#f7f4ed]">
      ...
      {/* Footer CTA */}
      <section className="relative py-16 md:py-24 lg:py-32 overflow-hidden bg-[#f4efe6]">
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-6 lg:px-8 flex justify-center md:justify-end">
          <div className="max-w-2xl text-center md:text-right flex flex-col items-center md:items-end w-full">
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-display font-bold leading-[1.1] tracking-[-1px] text-[#1c1c1c] mb-8 text-center md:text-right animate-fade-in w-full">
              Satu Platform <br />
              Untuk Seluruh <span className="italic font-normal text-rose-500">Ekosistem</span> Anda.
            </h2>
            <p className="text-base md:text-lg text-[#5f5f5d] mb-10 leading-[1.5] max-w-xl text-center md:text-right animate-fade-in delay-100 mx-auto md:mx-0">
              Apakah Anda calon pengantin yang ingin membuat undangan impian, atau vendoryang mengelola puluhan acara — Sahinaja siap mendukung Anda.
            </p>
            ...
            <div className="mt-14 flex items-center justify-center md:justify-end gap-6 text-xs text-[#5f5f5d]/50 font-medium tracking-widest uppercase">
              ...
              <span>Dashboard Gratis</span>
              <span className="h-1 w-1 rounded-full bg-[#1c1c1c]/10" />
              <span>Fitur Modular</span>
            </div>
          </div>
        </div>
      </section>
